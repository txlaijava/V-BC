...
public enum ResultStatus {
    ...
    RESCODE_REFTOKEN_MSG(106, "刷新TOKEN(有返回数据)","Refresh TOKEN(with return data)"),
    RESCODE_REFTOKEN(107, "刷新TOKEN","The refresh TOKEN"),
    JWT_ERRCODE_NULL(400, "Token不存在","Token does not exist"),
    JWT_ERRCODE_EXPIRE(401, "Token过期","Token expired"),
    JWT_ERRCODE_FAIL(402, "验证不通过","Validate against");
